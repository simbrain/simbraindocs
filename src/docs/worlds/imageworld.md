...
The purpose of these pipelines is to allow the image to be [coupled](../workspace/couplings) to a [neuron array](../network/arraysMatrices) or [neuron collection](../network/neuroncollections) with the appropriate number of neurons.
...
All pipeline operations share these properties:
...
For [common properties](#common-properties) like Enabled and Name, see above.
...
Converts color images to monochromatic (grayscale) using standard color space conversion. This operation has no configurable parameters beyond the [common properties](#common-properties) (Enabled and Name).
